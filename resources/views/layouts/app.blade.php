    ...
    <body>
        <div class="bg-primarycolor">
            ...
            <nav class="bg-navcolor w-80 flex flex-wrap justify-center items-center text-center mx-auto hover:text-gray-700 focus:text-gray-700 shadow-lg py-1 navbar">
                ...
                <li class="nav-item pr-4">
                    <a class="nav-link active hover:text-gray-700 focus:text-gray-700 p-2" href="{{url("experience")}}">My Experience</a>
                </li>
                <li class="nav-item pr-4">
                    <a class="nav-link active hover:text-gray-700 focus:text-gray-700 p-2" href="{{url("contact")}}">My Contact</a>
                </li>
                </ul>
            </nav>
        </div>
