...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="flex flex-col h-full justify-between">
            <header class="relative w-full h-72 md:h-24 overflow-hidden">
                <img class="object-cover w-full h-72 md:h-24 opacity-50 md:shrink-0" src="{{url("homes_images/home-bg.jpg")}}" alt="bg-image"/>
                <div>
                    <div class="absolute w-full py-2 bottom-0 inset-x-0">
            ...
            <footer class="text-center text-white bg-primarycolor bg-opacity-90">
                <div class="container pt-9">
                    <div class="flex justify-center mb-2">
                    <a href="https://mail.google.com/" class="mr-9 text-gray-800">
                    ...
                    <a href="https://www.linkedin.com/in/linyun-kee-appdev-webdev/" class="mr-9 text-gray-800">
                        <svg class="svg-inline--fa fa-linkedin-in w-3.5" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="linkedin-in" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                        <path
                            fill="currentColor"
                    ...
                    <a href="https://github.com/Lyunnn" class="text-gray-800">
                        <svg class="svg-inline--fa fa-github w-4" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="github" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
                        <path
                            fill="currentColor"
                    ...
                    <div class="relative flex-col py-5 items-center">
                    <div class="flex-grow border-t border-white w-1/3 mx-auto mb-3"></div>
                    <div class="flex-shrink text-center mx-auto text-white text-sm">&copy; 2022 by Lin Yun Kee</div>
                    <div class="flex-grow border-t border-white w-1/3 mx-auto mt-3"></div>
                    </div>
                </div>
            </footer>
        </div>
