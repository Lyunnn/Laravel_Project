...
@section('content')
    <h2 class="bg-titlecolor p-2 mx-32 justify-center items-center text-center my-8 font-display font-semibold text-3xl">Education</h2>
    <div class="bg-gray-100 mx-32">
        <p class="mx-20 pt-10 font-display font-semibold text-xl">University</p>
        <p class="mx-20">Griffith University</p>
        <p class="mx-20 pt-5 font-display font-semibold text-xl">Program</p>
        <p class="mx-20 pb-10">Nunc eu magna ac massa finibus blandit. Nulla laoreet fermentum lorem, ut sagittis ante.
