...
@section('content')
    <h2 class="w-80 bg-titlecolor flex flex-col justify-center mx-auto items-center my-8 font-display font-semibold text-3xl">Contact Me</h2>
    <div class="col-md-7">
        @if (count($errors) > 0)
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white py-10 px-6 shadow rounded-lg sm:px-10">
